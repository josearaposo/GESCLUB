        ...
        <>
            ...
            <div
                ...
                <div className="container mx-auto p-6 pt-32">
                    ...
                    <h1 className="text-2xl sm:text-4xl text-white font-bold mb-4">Gestión del Estadio</h1>
                                    ...
                                    <tr key={estadio.id} className="hover:bg-gray-200 ">
                                        ...
                                        <td className="border border-gray-300 px-4 py-2 align-center">
                                            <Link
                                                ...
                                                as="button"
                                                className="bg-cyan-700 text-white px-1 py-1 rounded hover:bg-green-600"
                                            >
                                                Zona de Abonados
                                            </Link>
                                        </td>
