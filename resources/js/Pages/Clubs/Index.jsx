    ...
    return (
        <>
            ...
            <div className="container mx-auto p-6">
                ...
                <div className="flex gap-2 mb-4 right-0">
                    {estado === 'activos' && (
                        <Link
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {clubs.map((club) => {
                            ...
                            return (
                                <div
                                    key={club.id}
                                    className={`relative w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ${isDeleted ? "opacity-60" : ""}`}
                                >
                                    {/* Botones */}
                                    {!isDeleted && (
                                        <Link
