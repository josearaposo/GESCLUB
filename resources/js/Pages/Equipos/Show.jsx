...
export default function Show({ equipo }) {
    return (
        <div className="max-w-4xl mx-auto mt-10 bg-white rounded-lg shadow-lg p-8">
            <h1 className="text-3xl font-bold text-green-700 mb-6">Detalles del Equipo</h1>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <p className="text-gray-500 text-sm">Nombre del equipo</p>
                    <h2 className="text-xl font-semibold">{equipo.nombre}</h2>
                </div>

                <div>
                    <p className="text-gray-500 text-sm">División</p>
                    <h2 className="text-xl font-semibold">{equipo.division.nombre}</h2>
                </div>

                <div>
                    <p className="text-gray-500 text-sm">Club</p>
                    <h2 className="text-xl font-semibold">{equipo.club.nombre}</h2>
                </div>
                <div>
